...
def plot_exchange_rate_error(df):   
    df.set_index("Block Number")["Exchange Rate Error"].plot(kind="line")
    plt.xlabel("Block Number")
    plt.ylabel("Exchange rate Error")
    plt.title("Exchange Rate Error")
    plt.yscale("log")
    plt.show()
